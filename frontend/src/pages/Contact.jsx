        ...
        <div className='w-[99vw] min-h-[100vh] flex items-center justify-center flex-col  bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px] pt-[80px]'>
            ...
            <div className='w-[100%]  flex items-center justify-center flex-col lg:flex-row'>
                ...
                <div className='lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px]  flex-col mt-[20px] lg:mt-[0px]'>
                    <p className='lg:w-[80%] w-[100%] text-[white] font-bold lg:text-[18px] text-[15px]'>Our online store</p>
                    <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
                        <p>221301</p>
                        <p>Bhadohi , U.P , India</p>
                    </p>
                    <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
                        <p>Mob: +91-8840475497</p>
                        <p>Email: rahul100jrs@gmail.com</p>
                    </p>
                    <p className='lg:w-[80%] w-[100%] text-[15px] text-[white] lg:text-[18px] mt-[10px] font-bold'>Careers at OneCart</p>
                    <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>Join OneCart and be a part of a fast-growing e-commerce team shaping the future of online shopping.
                        We offer exciting career opportunities, growth-focused culture, and a chance to innovate and make an impact. 🚀💼</p>

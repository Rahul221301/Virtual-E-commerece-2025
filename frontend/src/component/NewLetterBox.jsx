...
function NewLetterBox() {
    ...
    return (
        <div className='w-[100%] h-[40vh]  bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-start gap-[10px] flex-col'>
            <p className='md:text-[30px] text-[20px] text-[#a5faf7] font-semibold px-[20px]'>Sign up today and save 30% instantly!</p>
            <p className='md:text-[18px] text-[14px] text-center text-blue-100 font-semibold px-[20px]'>Sign up today and enjoy an instant 30% discount on your first purchase!, special deals, and early access to new collections.</p>
